...
| **Mirth Connect** | `4.4.0` (*to verify version) | **CRITICAL VULNERABILITY.** This version is susceptible to **CVE-2023-43208**. This is a pre-authentication Remote Code Execution (RCE) bug. |
<div align="center">
<br>
※※※※※※※※※※※※※※※※※※※※※※※※
<br>
