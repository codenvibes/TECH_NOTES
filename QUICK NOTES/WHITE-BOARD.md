...
the cutting edge may have some unknown or known bugs but it also means that you get the latest features so it is a trade-off to be aware of and the version that you choose is ultimately up to you 
